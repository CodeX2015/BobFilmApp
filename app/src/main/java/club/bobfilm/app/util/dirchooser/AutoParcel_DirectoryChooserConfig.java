...
final class AutoParcel_DirectoryChooserConfig extends DirectoryChooserConfig {
  ...
  public static final Creator<AutoParcel_DirectoryChooserConfig> CREATOR = new Creator<AutoParcel_DirectoryChooserConfig>() {
    @Override
  ...
  private final static ClassLoader CL = AutoParcel_DirectoryChooserConfig.class.getClassLoader();
